...
import com.textadventure.game.story.Adjective;
...
public class Enemy extends Actor {
    ...
    public Enemy(int inLevel, String inName) throws FileNotFoundException{
        this.badAdjObj = new Adjective();
        setLevel(inLevel);
        ...
        setExp (getMaxExp());
        name = badAdjObj.getRandomBadAdj() + " " + inName;
